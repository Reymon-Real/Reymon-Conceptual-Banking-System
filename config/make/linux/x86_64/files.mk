...
BINARY_LIBRARY_SHARED_SOVERSION_RCBS := $(MAKE_OUTPUT_LIBDIR)/libRCBS.so.$(RCBS_SYSTEM_SOVERSION)
BINARY_LIBRARY_SHARED_SYMLINK_RCBS   := $(MAKE_OUTPUT_LIBDIR)/libRCBS.so
